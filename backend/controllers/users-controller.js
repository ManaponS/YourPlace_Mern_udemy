...
const signup = async (req, res, next) => {
  ...
  try {
    ...
    const error = new HttpError("Hashed Password error", 500);
    return next(error);
  }
  ...
  try {
    ...
    const error = new HttpError("Signing Up new User Failed", 422);
    return next(error);
  }
  ...
  try {
    ...
    const error = new HttpError("Token Creation Faileds", 500);
    return next(error);
  }
